      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex gap-px bg-white/[0.025] rounded-lg p-px">
          {(["top_rated", "trending", "new"] as SortOption[]).map((s) => (
            ...
            >
              {s === "top_rated" ? "Top Rated" : s === "trending" ? "Trending" : "New"}
            </button>
          ))}
        </div>
        ...
        {hasActiveFilters && !showFilters && (
          <div className="flex items-center gap-1.5">
            {genre > 0 && (
              ...
              >
                {GENRE_LABELS[genre] ?? "Genre"} <span className="opacity-30">✕</span>
              </button>
            )}
            {language && (
              <button
                ...
                className="flex items-center gap-1 px-2 py-0.5 rounded bg-white/[0.03] text-white/25 text-[10px] cursor-pointer hover:text-white/40"
              >
                {LANG_LABELS[language] ?? language} <span className="opacity-30">✕</span>
              </button>
            )}
          </div>
        )}
          ...
          >
            <div className="rounded-lg bg-white/[0.015] border border-white/[0.03] px-4 py-3 mb-5">
              <div className="mb-2.5">
                <span className="text-white/12 text-[9px] uppercase tracking-wider">Genre</span>
                <div className="mt-1">
              ...
              <div>
                <span className="text-white/12 text-[9px] uppercase tracking-wider">Language</span>
                <div className="mt-1">
